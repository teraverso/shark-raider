...
public:
    ...
    void updatePortalDisplay(uint32_t uptime, int tot, int act, int cap, float sr, float ttc, float ttr, float ttl, float mem, int8_t rssi, bool running);
    void drawCredentialsScreen(const std::vector<String>& creds);
