...
void DisplayManager::initConsoleButtons() {
    ...
    // Nova ordem visual solicitada: BACK, SELECT, NEXT
    // A lógica de posição e índices permanece, apenas trocamos os labels (nomes)
...
void DisplayManager::drawMainMenu(int selectedIndex) {
    ...
    // Ordem: BEACON SPAM (0), RICK ROLL (1), EVIL PORTAL (2)
...
void DisplayManager::drawBeaconMenu(int selectedIndex) {
    ...
    // Ordem: FUNNY SSIDs (0), RANDOM SSIDs (1), CUSTOM SSIDs (2)
